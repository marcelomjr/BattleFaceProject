...
class IndexedCollectionView: UICollectionView {
    ...
    ///
    /// This should be set and updated only through CollectionTableViewCell's
...
class CollectionTableViewCell: UITableViewCell {
    ...
    /// of the IndexedCollectionView will paginate scroll or not.
    ///
    ...
    /// IndexedCollectionView inside CollectionTableViewCell.
    ///
    /// Call this `func` in your [tableView(_:willDisplay:forRowAt:)](apple-reference-documentation://hs3G9NleF7)
    /// method of TableCollectionViewController so the UITableView will
    ...
    /// IndexedCollectionView in the CollectionTableViewCell, responsible
    ...
    /// IndexedCollectionView, it's recommended to pass the same `indexPath`
    /// of the UITableViewCell to the IndexedCollectionView so they will share
